...
function Player() {
    ...
    return [
        ...
        <div className={"page-wrapper"} key="player-page-wrapper">
            ...
            />
            <div>
                <LoadoutDisplay playerData={playerData} items={items} gameMode={gameMode} />
                <RaidDataTable playerData={playerData} />
                <AchievementsDataTable playerData={playerData} />
...
function AchievementsDataTable({ playerData }) {
    const { t } = useTranslation();
...
function LoadoutDisplay({ playerData, items, gameMode }) {
    const { t } = useTranslation();
    ...
    if (!playerData.equipment?.Items?.length && !playerData?.favoriteItems?.length) {
        return null;
    }
...
function PlayerInfoDisplay({ playerData, handbook, playerBanned, turnstileToken, checkBanned }) {
    const { t } = useTranslation();
